// grab the form and the result box from the HTML
var form = document.getElementById("myForm");
var result = document.getElementById("result");

// clears every error message (we call this at the start of each submit)
...
form.addEventListener("submit", function (e) {
  ...
  if (ok == true) {
    result.innerHTML =
      ...
      "Reason: " + reason;
    result.classList.remove("d-none");   // d-none hides an element in Bootstrap, we remove it to show
  } else {
    result.classList.add("d-none");      // keep result hidden if there are errors
  }
});
